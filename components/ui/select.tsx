  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // **Selected / Checked**
        "data-[state=checked]:bg-sidebar-primary data-[state=checked]:text-sidebar-foreground",
