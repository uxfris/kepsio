...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center font-semibold transition-all duration-150 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed";

    const variants = {
      primary: "bg-primary text-surface hover:bg-primary-hover",
      accent: "bg-accent text-surface hover:bg-accent-hover",
      outline: "border border-border text-text-head hover:bg-section-light",
      ghost: "text-text-head hover:bg-section-light",
